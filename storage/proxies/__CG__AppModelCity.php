 ...
 */
class City extends \App\Model\City implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'urlRoute', 'regionalCenter', 'displayOrder', 'seoKeywords', 'seoTitle', 'seoDescription', 'event', 'image', 'images', 'createdAt', 'updatedAt', 'deletedAt', 'createdBy', 'deletedBy', 'updatedBy'];
        }
    ...
    public function isRegionalCenter()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isRegionalCenter', []);

        return parent::isRegionalCenter();
    }
    ...
    public function setRegionalCenter($regionalCenter)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRegionalCenter', [$regionalCenter]);

        return parent::setRegionalCenter($regionalCenter);
    }
     ...
     * {@inheritDoc}
     */
    public function removeImage(\App\Entities\Image $image)
    {
