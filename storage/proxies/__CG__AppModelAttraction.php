 ...
 */
class Attraction extends \App\Model\Attraction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'urlRoute', 'description', 'displayOrder', 'seoKeywords', 'seoTitle', 'seoDescription', 'city', 'image', 'createdAt', 'updatedAt', 'deletedAt', 'createdBy', 'deletedBy', 'updatedBy'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Attraction $proxy) {
