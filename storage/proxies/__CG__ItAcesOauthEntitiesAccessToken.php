 ...
 */
class AccessToken extends \ItAces\Oauth\Entities\AccessToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user', 'client', 'name', 'scopes', 'revoked', 'expiresAt', 'createdAt', 'updatedAt', 'deletedAt', 'createdBy', 'deletedBy', 'updatedBy'];
        }
